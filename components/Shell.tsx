"use client";
/**
 * Shell.tsx — UPDATED VERSION
 * ─────────────────────────────────────────────────────────────
 * Changes vs original:
 *   + AuthButton imported and placed top-right in header
 *   + AuthProvider wraps all children (so auth context is available everywhere)
 *   + No other changes — layout, nav, footer identical to original
 * ─────────────────────────────────────────────────────────────
 */
...
import { AuthButton } from "./auth-modal";  // ← NEW
...
export function Shell({
  ...
  return (
    // AuthProvider here ensures every page has auth context available
    <AuthProvider>
